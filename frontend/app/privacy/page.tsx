        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem 16px" }}>
            ...
            <div style={{ color: "var(--muted)", lineHeight: 1.6 }}>
                <p style={{ marginBottom: "1.5rem" }}>
                    At SheSignals, we prioritize the confidentiality and security of medical and demographic data. This privacy policy applies to the Autism Screening Application available via this domain.
                </p>
